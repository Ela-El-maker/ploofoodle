...
final class PublicAppGetStartedController extends PublicAppBaseController
{
    public function show(): void
    {
        ...
        $payload = [];
        try {
            $content = $this->webContentService()->getPublishedForPublic('app_get_started', $platform, $channel);
        ...
        $this->renderPublic('public/app/get_started.php', [
